...
/**
 * Base class for all types of game objects that can be generated
 * via a generic template. Examples of such objects include items,
 * equipment, and mobiles.
...
public class Template {
    ...
    /**
     * Creates a new templatable object that was defined in the
     * given area with the given id and names.
