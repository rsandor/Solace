...
public class Config {
	 ...
	 */
	protected static Hashtable<String, Configuration> configurations = new Hashtable<String, Configuration>();
	 ...
	 * @return The value for the name, or <code>null</code> if no such value could be found.
	 */
